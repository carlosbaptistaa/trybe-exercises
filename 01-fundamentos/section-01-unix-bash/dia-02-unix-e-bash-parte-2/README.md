...
1. Crie a pasta `unix_tests_skills` navegue até ela;
...
4. Tire a permissão de escrita do arquivo `arquivo_teste.txt` para todos os usuários, verifique se está correto com o comando `ls -l`;
